...
if __name__=="__main__":
    ...
    # saving behavior:
    save_new_config: bool = True

    # todo: consider preprocessing per task (since ICs might appear much too often in between trials)
    ...
    for channel_set in [
        ...
        save_dir: Path | str | None = subject_data_dir  # if None, nothing is saved
        ...
        if load_only_first_n_seconds: input_file = input_file[:2048*int(load_only_first_n_seconds), :]
